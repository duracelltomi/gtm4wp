...
final class AdminSchema implements AdminSchemaInterface {
	...
	public function title(): string {
		return esc_html__( 'Consent mode & consent tools', 'duracelltomi-google-tag-manager' );
	}
	...
	public function groups(): array {
		return array(
			'consent-mode'  => esc_html__( 'Google Consent Mode', 'duracelltomi-google-tag-manager' ),
			'consent-tools' => esc_html__( 'Consent management tools', 'duracelltomi-google-tag-manager' ),
		);
	}
