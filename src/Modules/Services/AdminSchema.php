...
/**
 * A section with no fields: the intro repeats the first sentence of the
...
final class AdminSchema implements AdminSchemaInterface, DocumentedSchemaInterface {
	...
	/**
	 * The first sentence of the services page and a link to it.
	 *
	 * @return string
	 */
	public function intro(): string {
		return sprintf(
			...
			esc_html__( 'Many agencies and freelancers use GTM4WP to build tracking for their clients.', 'duracelltomi-google-tag-manager' ),
