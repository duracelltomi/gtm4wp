	...
	GTM4WP_OPTION_SCROLLER_ENABLED      => array(
		...
		'description' => esc_html__( 'Enable scroll tracker script on your website.', 'duracelltomi-google-tag-manager' ) .
			gtm4wp_get_deprecation_notice(
				esc_html__( 'The whole scroll tracking feature is removed in GTM4WP 2.0: use the Scroll Depth trigger built into Google Tag Manager instead.', 'duracelltomi-google-tag-manager' )
			),
