...
|---|---|---|---|---|---|---|---|
| D14 | U16 | shipped | deprecation (declaration) | plugin header `WC tested up to` | Stable is **11.1.1** (2026-09-18), we declare 11.1.0; the patch's five fixes touch no registered coupling | Bump header + RELEASE-STATE + `ReleaseStateConsistencyTest` to 11.1.1 (a two-line change; needs the maintainer since it is a production header) | open |
