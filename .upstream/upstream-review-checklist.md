...
| WooCommerce | **11.1.1** [x] 2026-09-21 (S3) | **11.2.0-dev** (GitHub tag 2026-09-14; `release/11.2` branch cut, trunk already 11.3.0; no beta yet) | **11.2: Beta 1 21 Sep · Beta 2 28 Sep · RC 1 5 Oct · release 6 Oct 2026. 11.3: feature freeze 19 Oct · Beta 1 26 Oct · Beta 2 2 Nov · RC 1 9 Nov · release 10 Nov 2026. 11.4: feature freeze 23 Nov 2026** (the "WooCommerce Core Releases" Google Calendar embedded on developer.woocommerce.com/release-calendar/, read from a maintainer screenshot 2026-09-21 — the page is JS-rendered and blank to the fetcher; **next sweep: take the embed's public calendar id and register its iCal feed as the watch channel**, which is machine-readable) | `WC requires at least: 5.0` / `WC tested up to: 11.1.1` | **D14 closed the same day** (claim bumped 11.1.0 → 11.1.1) — the patch's 5 fixes touch no registered coupling (U16). Watch the 11.2.0-beta.1 tag for the next on-WC-release probe. (2026-09-07 (S2): claim bumped 11.0.0 → 11.1.0 after a full re-probe against the 11.1.0 source; #66748 event batching assessed benign, U145.)
