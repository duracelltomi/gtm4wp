...
| WooCommerce | **11.1.1** [x] 2026-09-21 (S3) | **11.2.0-dev** (GitHub tag 2026-09-14; no beta/RC yet) | ~2026-10 on the monthly cadence | `WC requires at least: 5.0` / `WC tested up to: 11.1.1` | **D14 closed the same day** (claim bumped 11.1.0 → 11.1.1) — the patch's 5 fixes touch no registered coupling (U16). Watch the 11.2.0-beta.1 tag for the next on-WC-release probe. (2026-09-07 (S2): claim bumped 11.0.0 → 11.1.0 after a full re-probe against the 11.1.0 source; #66748 event batching assessed benign, U145.)
