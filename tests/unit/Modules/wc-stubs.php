...
// code for four territories and is out of date for two more. The dialling facts
// now come from the generated CountryPhoneData, so nothing in the suite needs a
// countries double - and a stub kept "just in case" is a double with no
// collaborator, which is how a test starts passing for the wrong reason.
