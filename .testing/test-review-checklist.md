...
| **Google API client** (`src/Google/` — **5 files**: KeyVault 555 (clock seam added Run 10), ServiceAccountKey 179, TokenService 258, Transport 56 (interface, BE-3 N/A; its phase-2 methods ARE allow-list-tested), WpTransport 168 (SSRF egress guard; port refusal added Run 10). Landed 2026-09-03 `ea7ece7`, **row added Run 10**) | `Google/KeyVaultTest` (30), `TokenServiceTest` (26, incl. a RunInSeparateProcess sign-failure case), `ServiceAccountKeyTest`, `WpTransportTest` (16-row deny provider ×2 tests + seam), helpers `FakeTransport` (enforces the real allow-list, TS-13), `KeyFileFixture` (real RSA pair per process), `OptionStoreTrait` (core-faithful add/update semantics incl. unchanged-value false) | [x] 2026-09-03 | [x] 2026-09-03 | [x] 2026-09-03 (T70/T71 closed; openssl no-extension legs NOTE-documented untestable in-process) | [x] 2026-09-03 (deny-before-socket ×16 shapes ×3 methods; look-alike suffix + port + case rows) | [x] 2026-09-03 (#226/#227/#228 all revert-traced or probe-red; #231 wontfix no guard owed) | [x] 2026-09-03 |
