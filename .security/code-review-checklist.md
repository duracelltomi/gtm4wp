...
| **Frontend JS** (`js/frontend/`) | [-] | [x] 2026-07-13 | [x] 2026-07-13 | [-] | [x] 2026-07-13 | [x] 2026-07-13 | [-] |
...
| **Duplication / drift** (a helper coexisting with inline copies; a module escaping the dataLayer differently from siblings) | 2026-07-13 | Media trackers duplicate the percentage-milestone loop + `DOMContentLoaded`-ready boilerplate ~11× (finding #24, Low — payloads are provider-specific; `native-video-params.js` already extracts the shared `gtm.video*` mapping). Also: 3 older trackers miss the `if(!duration)return` guard the 6 new ones have (finding #20). (2026-07-10: eligibility/JSON-flag/`esc_js` drift, findings #8/#11/#12/#13.) |
| **Over-abstraction** (single-caller interfaces, forward-only wrappers, unread options) | 2026-07-13 | None material. `native-video-params.js` (shared by all 11 trackers) is justified. MediaEvents module wiring follows the framework (PA-6). (2026-07-10: `Field::rest_type()` dead, finding #10; framework justified.) |
